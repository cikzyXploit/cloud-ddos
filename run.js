...
`));
console.log(red + '\n╔══════════════════════════════════════╗');
console.log(red + '║' + yellow + '  SELAMAT DATANG DI TOOLS TRAVAS      ' + red + '║');
console.log(red + '╚══════════════════════════════════════╝\n' + reset);
}
...
const menuOptions = [
`${yellow}[${red}1${yellow}]${reset}${green} SlowRiss = ikzy [ time out ]${reset}`,
`${yellow}[${red}2${yellow}]${reset}${green} CrawlDos = ikzy [ time out ]${reset}`,
`${yellow}[${red}3${yellow}]${reset}${green} fastDuck = ikzy [ time out ]${reset}`,
`${yellow}[${red}4${yellow}]${reset}${green} netTcp = ikzy [ time out ]${reset}`,
`${yellow}[${red}5${yellow}]${reset}${green} httpEndpoint = ikzy [ time out ]${reset}`
];
...
console.log(green + `🚀 Starting By IkzyXmodz ${getMethodName(methodNum)} attack on ${url} for ${time} seconds...` + reset);
